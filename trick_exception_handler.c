...
int main(){
  ...
  // exception
  //  832:   f3 0f 10 4d fc          movss  -0x4(%rbp),%xmm1                                       // xmm1 = nan
  //  837:   f3 0f 10 05 f9 00 00    movss  0xf9(%rip),%xmm0        # 938 <_IO_stdin_used+0x48>    // xmm0 = 1.0
  //  83e:   00 
  //  83f:   f3 0f 58 c1             addss  %xmm1,%xmm0                                            // xmm0 = xmm1 + xmm0
  //  843:   f3 0f 11 45 f8          movss  %xmm0,-0x8(%rbp)                                       // a = xmm0
  a = nan + 1.0;
